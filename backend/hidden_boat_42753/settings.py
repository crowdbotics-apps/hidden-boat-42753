"""
Django settings for hidden_boat_42753 project.
...
ROOT_URLCONF = 'hidden_boat_42753.urls'
...
WSGI_APPLICATION = 'hidden_boat_42753.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "hidden_boat_42753 API",
    "DESCRIPTION": "API documentation for hidden_boat_42753 App",
    "VERSION": "v1",
}
